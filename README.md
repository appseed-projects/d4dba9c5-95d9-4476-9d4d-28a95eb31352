...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-04 16:37`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d4dba9c5-95d9-4476-9d4d-28a95eb31352.git
$ cd d4dba9c5-95d9-4476-9d4d-28a95eb31352
```
